...
// Store
import { useSimulationResult } from "@/store/useSimulationResultStore";
            ...
            <div className="hidden md:block fixed top-0 start-0 w-full">
              <div className="relative mx-auto max-w-screen-md mt-40 flex flex-col md:flex-row gap-4">
                ...
                <div className="flex-[1] order-1 md:order-2 ">
                  <div className={`w-full h-[20rem] overflow-y-scroll grid grid-cols-3 gap-2 justify-center items-center mt-4 ${Test.hidescrollbar}`}>
                    {result.map((item, index) => (
                      <a
                        key={item.question_id}
                        href={`#${index}`}
